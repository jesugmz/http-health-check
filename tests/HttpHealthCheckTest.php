...
class HttpHealthCheckTest extends TestCase
{
    ...
    public function testIsAliveReturnsTrueWithNoChecks()
    {
        $check = $this->mockCheckInstance(new Response, 'http://dummy-url');
        $this->assertTrue($check->isAlive());
    }

    public function testIsAliveReturnsTrueWithExpectedStatusCode()
    {
        $statusCode = 200;
    ...
    public function testIsAliveReturnsFalseWithUnexpectedStatusCode()
    {
        $check = $this->mockCheckInstance(
            new Response(404),
            'http://dummy-url',
        ...
        $this->assertFalse($check->isAlive());
    }

    public function testIsAliveReturnsTrueWithExpectedPlainTextBodyContent()
    {
        $bodyContent = 'sample';
    ...
    public function testIsAliveReturnsTrueWithExpectedPartialBodyContent()
    {
        $check = $this->mockCheckInstance(
    ...
    public function testIsAliveReturnsFalseWithUnexpectedBodyContent()
    {
        $check = $this->mockCheckInstance(
